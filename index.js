...
const changeCity = require('./changeCity')
const changeSize = require('./changeSize')
...
// change car city
app.post('/updateCity', function (req, res) {
    changeCity.main( req.body  )
    .then(result => {
        res.send({message: 'Updated successfully'})
    })
    .catch(err => {
...
app.post('/updateSize', function (req, res) {
    changeSize.main( req.body  )
    .then(result => {
        res.send({message: 'Updated successfully'})
    })
    .catch(err => {
